...
# fork VN: registry cho formatter cua ngon ngu them ngoai tree (lang -> callable).
_EXTRA_FORMATTERS: Dict[str, Any] = {}
...
def format_market_phase_prompt_section(
    ...
    *,
    ...
    # fork VN: ngon ngu them ngoai tree dang ky formatter o day thay vi ghi de
    # _format_zh. Xem src/market_phase_prompt_vi.py + docs/vn-fork-touchpoints.md.
    extra = _EXTRA_FORMATTERS.get(normalized)
...
# fork VN: dang ky formatter tieng Viet. Dat o CUOI file de moi helper da ton tai.
from src.market_phase_prompt_vi import register as _register_vi  # noqa: E402
