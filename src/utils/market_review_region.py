...
# fork VN: them "vn". Upstream gom moi noi ve hang so nay nen day la DIEM CHAM
# DUY NHAT cho market-review region — config, API schema, market_review deu doc tu day.
MARKET_REVIEW_REGION_ORDER = ("cn", "hk", "us", "jp", "kr", "vn")
