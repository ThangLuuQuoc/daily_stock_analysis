...
def _get_market_review_text(language: str) -> dict[str, str]:
    ...
    if normalized == "vi":
        return {
            ...
            "jp_title": "# Phân tích thị trường Nhật Bản",
            "kr_title": "# Phân tích thị trường Hàn Quốc",
...
def _build_market_review_context_overview(
    *,
    ...
    label = (
        ...
        else "Phân tích thị trường" if report_language == "vi"
...
def _summarize_market_review(review_report: str, report_language: str) -> str:
    ...
    if report_language == "vi":
        return "Đã tạo báo cáo phân tích thị trường."
