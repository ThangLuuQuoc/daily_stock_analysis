...
const QUICK_QUESTIONS: Array<{
  ...
  { label: { zh: '用缠论分析茅台', en: 'Analyze Moutai with Chan theory', vi: 'Phân tích Moutai bằng lý thuyết Chan' }, skill: 'chan_theory', stockContext: { stock_code: '600519', stock_name: '贵州茅台' } },
  { label: { zh: '波浪理论看宁德时代', en: 'View CATL with wave theory', vi: 'Xem CATL bằng lý thuyết sóng' }, skill: 'wave_theory', stockContext: { stock_code: '300750', stock_name: '宁德时代' } },
  { label: { zh: '分析比亚迪趋势', en: 'Analyze BYD trend', vi: 'Phân tích xu hướng BYD' }, skill: 'bull_trend', stockContext: { stock_code: '002594', stock_name: '比亚迪' } },
  { label: { zh: '箱体震荡技能看中芯国际', en: 'View SMIC with box oscillation', vi: 'Xem SMIC bằng dao động hộp' }, skill: 'box_oscillation', stockContext: { stock_code: '688981', stock_name: '中芯国际' } },
  { label: { zh: '分析腾讯 hk00700', en: 'Analyze Tencent hk00700', vi: 'Phân tích Tencent hk00700' }, skill: 'bull_trend', stockContext: { stock_code: 'HK00700', stock_name: '腾讯控股' } },
  { label: { zh: '用情绪周期分析东方财富', en: 'Analyze East Money with emotion cycle', vi: 'Phân tích East Money theo chu kỳ cảm xúc' }, skill: 'emotion_cycle', stockContext: { stock_code: '300059', stock_name: '东方财富' } },
];

const CHAT_TEXT = {
  historyTitle: { zh: '历史对话', en: 'Chat history', vi: 'Lịch sử trò chuyện' },
  newChatAria: { zh: '开启新对话', en: 'Start new chat', vi: 'Bắt đầu trò chuyện mới' },
  loadingChats: { zh: '加载对话中...', en: 'Loading chats...', vi: 'Đang tải hội thoại...' },
  noChats: { zh: '暂无历史对话', en: 'No chat history', vi: 'Chưa có lịch sử trò chuyện' },
  noChatsDesc: { zh: '开始提问后，这里会保留会话记录。', en: 'Sessions appear here once you start asking.', vi: 'Sau khi bắt đầu hỏi, các phiên sẽ hiển thị ở đây.' },
  messageCountUnit: { zh: '条对话', en: 'messages', vi: 'tin nhắn' },
  deleteChatTitle: { zh: '删除对话', en: 'Delete chat', vi: 'Xóa cuộc trò chuyện' },
  deleteChatMessage: { zh: '删除后，该对话将不可恢复，确认删除吗？', en: 'This chat cannot be recovered after deletion. Delete it?', vi: 'Cuộc trò chuyện không thể khôi phục sau khi xóa. Xóa chứ?' },
  delete: { zh: '删除', en: 'Delete', vi: 'Xóa' },
  cancel: { zh: '取消', en: 'Cancel', vi: 'Hủy' },
  historyAria: { zh: '历史对话', en: 'Chat history', vi: 'Lịch sử trò chuyện' },
  title: { zh: '问股', en: 'Ask Stocks', vi: 'Hỏi cổ phiếu' },
  exportTooltip: { zh: '导出会话为 Markdown 文件', en: 'Export session as Markdown file', vi: 'Xuất phiên thành tệp Markdown' },
  exportSession: { zh: '导出会话', en: 'Export session', vi: 'Xuất phiên' },
  sendTooltip: { zh: '发送到已配置的通知机器人/邮箱', en: 'Send to configured notification bot/email', vi: 'Gửi tới bot/email thông báo đã cấu hình' },
  send: { zh: '发送', en: 'Send', vi: 'Gửi' },
  sendSuccess: { zh: '已发送到通知渠道', en: 'Sent to notification channel', vi: 'Đã gửi tới kênh thông báo' },
  sendFailed: { zh: '发送失败', en: 'Send failed', vi: 'Gửi thất bại' },
  sendSuccessTitle: { zh: '发送成功', en: 'Sent', vi: 'Đã gửi' },
  intro: { zh: '向 AI 询问个股分析，获取基于技能视角的交易建议与实时决策报告。', en: 'Ask the AI for stock analysis to get skill-based trading advice and real-time decision reports.', vi: 'Hỏi AI để phân tích cổ phiếu, nhận lời khuyên giao dịch theo kỹ năng và báo cáo quyết định thời gian thực.' },
  emptyTitle: { zh: '开始问股', en: 'Start asking', vi: 'Bắt đầu hỏi' },
  emptyDesc: { zh: '输入「分析 600519」或「茅台现在能买吗」，AI 将调用实时数据工具为您生成决策报告。', en: 'Type "Analyze 600519" or "Can I buy Moutai now", and the AI will use real-time data tools to generate a decision report.', vi: 'Nhập "Phân tích 600519" hoặc "Có nên mua Moutai bây giờ", AI sẽ dùng công cụ dữ liệu thời gian thực để tạo báo cáo quyết định.' },
  exportMessageAria: { zh: '导出此条消息为 Markdown', en: 'Export this message as Markdown', vi: 'Xuất tin nhắn này thành Markdown' },
  exportShort: { zh: '导出', en: 'Export', vi: 'Xuất' },
  connecting: { zh: '正在连接...', en: 'Connecting...', vi: 'Đang kết nối...' },
  thinking: { zh: 'AI 正在思考...', en: 'AI is thinking...', vi: 'AI đang suy nghĩ...' },
  done: { zh: '完成', en: 'done', vi: 'hoàn tất' },
  generatingFinal: { zh: '正在生成最终分析...', en: 'Generating final analysis...', vi: 'Đang tạo phân tích cuối cùng...' },
  processing: { zh: '处理中...', en: 'Processing...', vi: 'Đang xử lý...' },
  toolCallsUnit: { zh: '个工具调用', en: 'tool calls', vi: 'lần gọi công cụ' },
  thinkingProcess: { zh: '思考过程', en: 'Thinking process', vi: 'Quá trình suy nghĩ' },
  stepThink: { zh: '步：思考', en: ': thinking', vi: ': suy nghĩ' },
  generateAnalysis: { zh: '生成分析', en: 'Generate analysis', vi: 'Tạo phân tích' },
  jumpNewMessage: { zh: '查看最新消息', en: 'View latest message', vi: 'Xem tin nhắn mới nhất' },
  newMessage: { zh: '有新消息', en: 'New message', vi: 'Tin nhắn mới' },
  followUpLoadingTitle: { zh: '追问上下文加载中', en: 'Loading follow-up context', vi: 'Đang tải ngữ cảnh hỏi tiếp' },
  followUpLoadingMsg: { zh: '正在加载历史分析上下文；现在可直接发送追问。', en: 'Loading historical analysis context; you can send follow-ups now.', vi: 'Đang tải ngữ cảnh phân tích trước đó; bạn có thể gửi câu hỏi tiếp ngay.' },
  contextCompression: { zh: '上下文压缩', en: 'Context compression', vi: 'Nén ngữ cảnh' },
  contextCompressionHint: { zh: '节省长会话 token', en: 'Save tokens in long sessions', vi: 'Tiết kiệm token cho phiên dài' },
  saving: { zh: '保存中...', en: 'Saving...', vi: 'Đang lưu...' },
  enabled: { zh: '已启用', en: 'Enabled', vi: 'Đã bật' },
  disabled: { zh: '未启用', en: 'Disabled', vi: 'Chưa bật' },
  contextCompressionLoadError: { zh: '无法读取上下文压缩配置', en: 'Unable to read context compression config', vi: 'Không đọc được cấu hình nén ngữ cảnh' },
  contextCompressionSaveError: { zh: '上下文压缩设置保存失败', en: 'Failed to save context compression setting', vi: 'Lưu cài đặt nén ngữ cảnh thất bại' },
  contextCompressionUnsavedTitle: { zh: '上下文压缩设置未保存', en: 'Context compression setting not saved', vi: 'Cài đặt nén ngữ cảnh chưa được lưu' },
  expandStrategy: { zh: '展开策略选择', en: 'Expand strategy selection', vi: 'Mở rộng lựa chọn chiến lược' },
  collapseStrategy: { zh: '收起策略选择', en: 'Collapse strategy selection', vi: 'Thu gọn lựa chọn chiến lược' },
  strategy: { zh: '策略', en: 'Strategy', vi: 'Chiến lược' },
  generalAnalysis: { zh: '通用分析', en: 'General analysis', vi: 'Phân tích chung' },
  general: { zh: '通用', en: 'General', vi: 'Chung' },
  removeFromWatchlist: { zh: '从自选删除', en: 'Remove from watchlist', vi: 'Xóa khỏi danh mục theo dõi' },
  addToWatchlist: { zh: '加入自选', en: 'Add to watchlist', vi: 'Thêm vào danh mục theo dõi' },
  inputPlaceholder: {
    zh: '例如：分析 600519 / 茅台现在适合买入吗？ (Enter 发送, Shift+Enter 换行)',
    en: 'e.g. Analyze 600519 / Is Moutai a good buy now? (Enter to send, Shift+Enter for newline)',
    vi: 'Ví dụ: Phân tích 600519 / Moutai có nên mua bây giờ? (Enter để gửi, Shift+Enter để xuống dòng)',
  },
  userMessageHeading: { zh: '用户消息', en: 'User message', vi: 'Tin nhắn người dùng' },
  aiReplyHeading: { zh: 'AI 回复', en: 'AI reply', vi: 'AI trả lời' },
  documentTitle: { zh: '问股 - DSA', en: 'Ask Stocks - DSA', vi: 'Hỏi cổ phiếu - DSA' },
  operationFailed: { zh: '操作失败，请重试', en: 'Operation failed, please retry', vi: 'Thao tác thất bại, vui lòng thử lại' },
} satisfies Record<string, LocalText>;

const buildWatchlistRemovedMsg = (language: UiLanguage, stockCode: string): string => {
  if (language === 'en') return `Removed ${stockCode} from watchlist`;
  if (language === 'vi') return `Đã xóa ${stockCode} khỏi danh mục theo dõi`;
  return `已从自选中移除 ${stockCode}`;
};

const buildWatchlistAddedMsg = (language: UiLanguage, stockCode: string): string => {
  if (language === 'en') return `Added ${stockCode} to watchlist`;
  if (language === 'vi') return `Đã thêm ${stockCode} vào danh mục theo dõi`;
  return `已加入自选 ${stockCode}`;
};

const buildSwitchSessionAria = (language: UiLanguage, title: string): string => {
  if (language === 'en') return `Switch to chat ${title}`;
  if (language === 'vi') return `Chuyển sang cuộc trò chuyện ${title}`;
  return `切换到对话 ${title}`;
};

const buildDeleteSessionAria = (language: UiLanguage, title: string): string => {
  if (language === 'en') return `Delete chat ${title}`;
  if (language === 'vi') return `Xóa cuộc trò chuyện ${title}`;
  return `删除对话 ${title}`;
};

const buildSkillAria = (language: UiLanguage, label: string): string => {
  if (language === 'en') return `Skill ${label}`;
  if (language === 'vi') return `Kỹ năng ${label}`;
  return `技能 ${label}`;
};

const buildStepLabel = (language: UiLanguage, step: number | string = ''): string => {
  if (language === 'en') return `Step ${step}: thinking`;
  if (language === 'vi') return `Bước ${step}: suy nghĩ`;
  return `第 ${step} 步：思考`;
};
...
const ChatPage: React.FC = () => {
  ...
  // Get localized text based on current UI language
  ...
  // Set page title
  useEffect(() => {
    document.title = CHAT_TEXT.documentTitle[language];
  }, [language]);
  ...
  const handleToggleWatchlist = useCallback(
    async (stockCode: string) => {
      ...
      try {
        ...
        if (existingStockCode) {
          ...
          if (isMountedRef.current) {
            setWatchlistCodes(codes);
            setWatchlistMessage(buildWatchlistRemovedMsg(language, stockCode));
          }
        } else {
          const codes = await systemConfigApi.addToWatchlist(stockCode);
          if (isMountedRef.current) {
            setWatchlistCodes(codes);
            setWatchlistMessage(buildWatchlistAddedMsg(language, stockCode));
          }
        }
      } catch {
        if (isMountedRef.current) {
          setWatchlistMessage(CHAT_TEXT.operationFailed[language]);
        }
      } finally {
        if (isMountedRef.current) {
    ...
    [isWatchlistActioning, language, watchlistCodes],
  );
  ...
  useEffect(() => {
    ...
    void systemConfigApi.getConfig(false)
      ...
      .catch((error) => {
        ...
        setContextCompressionError(parsed.message || CHAT_TEXT.contextCompressionLoadError[language]);
  ...
  const updateContextCompressionEnabled = useCallback(
    async (nextEnabled: boolean) => {
      ...
      try {
        ...
        setContextCompressionError(parsed.message || CHAT_TEXT.contextCompressionSaveError[language]);
      } finally {
  ...
  const handleSend = useCallback(
    async (
      ...
      await startStream(payload, {
        ...
        skillName: usedSkillNames.join(listSeparator),
        onAccepted: () => {
  ...
  const handleQuickQuestion = (q: (typeof QUICK_QUESTIONS)[0]) => {
    ...
    handleSend(q.label[language], [q.skill], q.stockContext);
  };
  ...
  const downloadMessageAsMarkdown = useCallback((msg: Message) => {
    const skillLabel = getMessageSkillLabel(msg, listSeparator);
    const heading = msg.role === 'user'
      ? `# ${CHAT_TEXT.userMessageHeading[language]}`
      : `# ${CHAT_TEXT.aiReplyHeading[language]}${skillLabel ? ` · ${skillLabel}` : ''}`;
  ...
  }, [language, listSeparator]);

  const getCurrentStage = (steps: ProgressStep[]): string => {
    if (steps.length === 0) return CHAT_TEXT.connecting[language];
    const last = steps[steps.length - 1];
    if (last.type === 'thinking') return last.message || CHAT_TEXT.thinking[language];
    if (last.type === 'tool_start')
      return `${last.display_name || last.tool}...`;
    if (last.type === 'tool_done')
      return `${last.display_name || last.tool} ${CHAT_TEXT.done[language]}`;
    ...
    if (last.type === 'generating')
      return last.message || CHAT_TEXT.generatingFinal[language];
    return CHAT_TEXT.processing[language];
  };
  ...
  const renderThinkingBlock = (msg: Message) => {
    ...
    const summary = `${toolSteps.length} ${CHAT_TEXT.toolCallsUnit[language]} · ${totalDuration.toFixed(1)}s`;
    ...
    return (
      ...
      >
        ...
        <span className="flex items-center gap-1.5">
          <span className="opacity-60">{CHAT_TEXT.thinkingProcess[language]}</span>
    ...
    <div className="mb-3 pl-5 border-l border-border/40 space-y-1.5 animate-fade-in">
      {steps.map((step, idx) => {
        ...
        if (step.type === 'thinking') {
          text = step.message || buildStepLabel(language, step.step);
          ...
          text = step.message || CHAT_TEXT.generateAnalysis[language];
      ...
      <ScrollArea testId="chat-session-list-scroll" viewportClassName="p-3">
        {sessionsLoading ? (
          <DashboardStateBlock
            loading
            compact
            title={CHAT_TEXT.loadingChats[language]}
            className="rounded-2xl border border-dashed border-border/50 bg-surface/30"
          />
        ) : sessions.length === 0 ? (
          <DashboardStateBlock
            compact
            title={CHAT_TEXT.noChats[language]}
            description={CHAT_TEXT.noChatsDesc[language]}
            className="rounded-2xl border border-dashed border-border/50 bg-surface/30"
          />
        ) : (
            ...
            {sessions.map((s) => (
              <div key={s.session_id} className="session-item-row">
                <button
                  ...
                  aria-label={buildSwitchSessionAria(language, s.title)}
                ...
                >
                  ...
                  <div className="content">
                    ...
                    <div className="mt-0.5 flex items-center gap-2">
                      <span className="meta">
                        {s.message_count} {CHAT_TEXT.messageCountUnit[language]}
                      </span>
                      {s.last_active && (
                        <>
                          <span className="separator" />
                          <span className="meta">
                            {new Date(s.last_active).toLocaleDateString(language === 'en' ? 'en-US' : language === 'vi' ? 'vi-VN' : 'zh-CN', { month: 'short', day: 'numeric' })}
                          </span>
                        </>
                      )}
                    </div>
                ...
                <button
                  ...
                  aria-label={buildDeleteSessionAria(language, s.title)}
                >
                  <svg
  ...
  const selectedSkillSummary = selectedSkillIds.length > 0
    ? getSkillNames(selectedSkillIds).join(listSeparator)
    : CHAT_TEXT.generalAnalysis[language];
  ...
  return (
    ...
    >
      ...
      <ConfirmDialog
        ...
        title={CHAT_TEXT.deleteChatTitle[language]}
        message={CHAT_TEXT.deleteChatMessage[language]}
        confirmText={CHAT_TEXT.delete[language]}
        cancelText={CHAT_TEXT.cancel[language]}
        isDanger
        ...
        <header className="mb-4 flex-shrink-0 space-y-3">
          <div className="flex items-start justify-between gap-4">
            <h1 className="text-2xl font-bold text-foreground flex items-center gap-2">
              <button
                ...
                aria-label={CHAT_TEXT.historyAria[language]}
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
            ...
            {messages.length > 0 && (
              <div className="flex flex-shrink-0 flex-wrap items-center justify-end gap-2">
                <Tooltip content={CHAT_TEXT.exportTooltip[language]}>
                  <span className="inline-flex">
                    <Button
                      variant="action-primary"
                      size="sm"
                      onClick={() => downloadSession(messages)}
                      aria-label={CHAT_TEXT.exportTooltip[language]}
                    >
                      <svg
                        className="w-4 h-4"
                        fill="none"
                      ...
                      {CHAT_TEXT.exportSession[language]}
                    </Button>
                  </span>
                </Tooltip>
                <Tooltip content={CHAT_TEXT.sendTooltip[language]}>
                  <span className="inline-flex">
                    <Button
                      variant="action-primary"
                      size="sm"
                      ...
                      onClick={async () => {
                        ...
                        try {
                          ...
                          showSendFeedback({ type: 'success', message: CHAT_TEXT.sendSuccess[language] }, 3000);
                        } catch (err) {
                          const parsed = getParsedApiError(err);
                          showSendFeedback({
                            type: 'error',
                            message: parsed.message || CHAT_TEXT.sendFailed[language],
                          }, 5000);
                        } finally {
                          setSending(false);
                        }
                      }}
                      aria-label={CHAT_TEXT.sendTooltip[language]}
                    >
                      {sending ? (
                        <svg
          ...
          {sendToast ? (
            <InlineAlert
              ...
              title={sendToast.type === 'success' ? CHAT_TEXT.sendSuccessTitle[language] : CHAT_TEXT.sendFailed[language]}
          ...
          >
            {messages.length === 0 && !loading ? (
              <div className="flex h-full items-center justify-center">
                <EmptyState
                  title={CHAT_TEXT.emptyTitle[language]}
                  description={t(
                    agentStatus?.backend === 'codex_app_server'
                  ...
                  >
                    {msg.role === 'assistant' && (skillLabel || msg.backend) && (
                      <div className="mb-2 flex flex-wrap gap-2">
                        {skillLabel ? <Badge variant="info" className="chat-skill-badge shadow-none" aria-label={buildSkillAria(language, skillLabel)}>
                          <svg
                            className="w-3 h-3"
                            fill="none"
                            stroke="currentColor"
                      ...
                      <div className="relative">
                        <div className="chat-message-actions">
                          ...
                          <button
                            ...
                            className="chat-copy-btn"
                            aria-label={CHAT_TEXT.exportMessageAria[language]}
                          >
                            {CHAT_TEXT.exportShort[language]}
                          </button>
                        </div>
          ...
          {showJumpToBottom && (
            <div className="pointer-events-none absolute bottom-[5.75rem] right-4 z-20 md:bottom-24 md:right-6">
              <button
                ...
                aria-label={CHAT_TEXT.jumpNewMessage[language]}
              >
                <svg
          ...
          <div className="border-t border-white/6 bg-card/88 p-4 md:p-6 relative z-20">
            <div className="space-y-3">
              ...
              {isFollowUpContextLoading ? (
                <InlineAlert
                  variant="info"
                  title={CHAT_TEXT.followUpLoadingTitle[language]}
                  message={CHAT_TEXT.followUpLoadingMsg[language]}
                  className="rounded-xl px-3 py-2 text-xs shadow-none"
                />
              ) : null}
              <div className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-white/6 bg-surface/25 px-3 py-2">
                ...
                >
                  ...
                  />
                  <span className="font-medium">{CHAT_TEXT.contextCompression[language]}</span>
                  <span className="text-xs text-muted-text">{CHAT_TEXT.contextCompressionHint[language]}</span>
                </label>
                <span className="text-xs text-muted-text">
                  {contextCompressionSaving
                    ? CHAT_TEXT.saving[language]
                    : contextCompressionEnabled
                      ? CHAT_TEXT.enabled[language]
                      : CHAT_TEXT.disabled[language]}
                </span>
              </div>
              {contextCompressionError ? (
                <InlineAlert
                  variant="danger"
                  title={CHAT_TEXT.contextCompressionUnsavedTitle[language]}
              ...
              {skills.length > 0 && (
                <div className="space-y-2">
                  <button
                    ...
                    aria-label={mobileSkillPickerOpen ? CHAT_TEXT.collapseStrategy[language] : CHAT_TEXT.expandStrategy[language]}
                  ...
                  >
                    <span className="flex min-w-0 items-center gap-2">
                      ...
                      <span className="flex-shrink-0 font-medium">{CHAT_TEXT.strategy[language]}</span>
            ...
            {activeStockCode && (
              <div className="flex items-center gap-2">
                ...
                <Button
                  ...
                  className="text-[11px]"
                >
                  {stockInWatchlist(activeStockCode) ? CHAT_TEXT.removeFromWatchlist[language] : CHAT_TEXT.addToWatchlist[language]}
                </Button>
                {watchlistMessage && (
              ...
              <div className="flex items-end gap-3">
                <textarea
                  ...
                  placeholder={CHAT_TEXT.inputPlaceholder[language]}
